...
const TeacherForm = ({isopend}) => {
  ...
  const handleSubmitTeacher = async (e) =>{
    ...
    try{
      const response = await axios.post(POST_TEACHER_URL, 
        JSON.stringify({name, surname, nationalIdNumber, title, teacherNumber, salary, 
          dob}),
        {
          ...
          <div className="details personal">
            ...
            <div className="fields">
              ...
              <div className="input-fields">
                ...
                type='number' placeholder='Enter Salary' required/>
              </div>
            </div>
